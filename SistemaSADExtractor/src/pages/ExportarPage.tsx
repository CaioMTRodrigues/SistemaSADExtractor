...
const initialRows: Row[] = [
    ...
    { id: 2, name: "Laudo_xxx.pdf", extracted: 1, total: 10, confidence: 10, action: "prosseguir" },
];
...
export default function ExportarPage() {
    ...
    function exportar() {
        if (!selectedCount) return alert("Selecione pelo menos 1 laudo.");
        if (!selectedFormat) return alert("Selecione o formato.");
        alert(`Exportando ${selectedCount} laudo(s) como ${selectedFormat}...`);
    }
                    ...
                    <section className={styles.card}>
                        ...
                        <div className={styles.bottomBar}>
                            ...
                            <div className={styles.exportBox}>
                                ...
                                <button className={styles.btnPrimary} onClick={exportar}>Baixar laudos</button>
                            </div>
                        </div>
                    </section>
                </div>
